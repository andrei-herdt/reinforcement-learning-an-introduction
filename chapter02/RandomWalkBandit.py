...
class RandomWalkBandit:
    ...
    def __init__(self, kArm=10, epsilon=0., initial=0., stepSize=0.1, sampleAverages=False, UCBParam=None,
                 gradient=False, gradientBaseline=False, trueReward=0., noiseSigma=0.):
        self.k = kArm
        ...
        self.qTrue = [trueReward for _ in range(kArm)]
    ...
    def takeAction(self, action):
        ...
        self.qTrue[action] += self.noiseSigma * np.random.randn()
        self.time += 1
